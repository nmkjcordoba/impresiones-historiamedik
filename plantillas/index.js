...
<body>
    ...
    <main class="main">
        ...
        <div class="info-patient">
            <table>
                <tr>
                    <td><p><b>Nombre: </b><span>@nombreCompleto </span></p></td>
                    <td><p><b>Documento: </b> @tipo_identificacion @identificacion </p></td>
                    <td><p><b>Genero: </b> @genero </p></td>
                </tr>
                
                <tr>
                    <td><p><b>Edad: </b> @edad </p></td>
                    <td><p><b>Estado Civil: </b> @EstadoCivil </p></td>
                    <td><p><b>Telefono 1: </b> @Telefono </p></td>
                </tr>
                <tr>
                    <td><p><b>Telefono 2: </b> @Telefono2 </p></td>
                    <td><p><b>Dirección: </b> @Direccion </p></td>
                    <td><p><b>Tipo Afiliación: </b> @TipoAfiliacion </p></td>
                </tr>
                <tr>
                    <td><p><b>EPS: </b> @eps </p></td>
                    <td><p><b>Diagnostico: </b> @diagnostico </p></td>
                    <td><p><b>CUP: </b> @cup </p></td>
                </tr>
            </table>
        </div>
        <hr>
