...
module.exports = {
    ...
    ordenPrueba:() => {
        ...
        <ol>
            <li>
                Accidente de ala delta con ocupante lesionado
            </li>
        </ol>
        <hr>
    </div>
    <div class="table">
        <table >
            <thead>
                <tr>
                    <td class="content1">Antecedente</td>
                    <td class="content2">Observación</td>
                    <td class="content3">Estado</td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td >Accidente de ala delta, con ocupante lesionado</td>
                    <td>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum rem est laborum error hic earum officia rerum illum pariatur magni delectus tempora molestiae, consequatur odio reprehenderit enim sunt cupiditate provident.</td>
                    <td>Confirmado</td>
                </tr>
                <tr>
                    <td >Accidente de ala delta, con ocupante lesionado</td>
...
<body>
    ...
    <main class="main">
        ...
        <div class="info-patient">
            <table>
                <tr>
                    <td><p><b>Nombre: </b><span>@nombre_paciente </span></p></td>
                    <td><p><b>Documento: </b> @tipo_documento_paciente @documento_paciente </p></td>
                    <td><p><b>Genero: </b> @genero_paciente </p></td>
                </tr>
                
                <tr>
                    <td><p><b>Edad: </b> @edad_paciente </p></td>
                    <td><p><b>Estado Civil: </b> @estado_civil_paciente </p></td>
                    <td><p><b>Telefono 1: </b> telefono1_paciente </p></td>
                </tr>
                <tr>
                    <td><p><b>Telefono 2: </b> @telefono2_paciente </p></td>
                    <td><p><b>Dirección: </b> @direccion_paciente </p></td>
                    <td><p><b>Tipo Afiliación: </b> @tipo_afiliacion_paciente </p></td>
                </tr>
                <tr>
                    <td><p><b>EPS: </b> @pagador </p></td>
                    <td><p><b>Diagnostico: </b> @diagnostico </p></td>
                    <td></td>
                </tr>
            </table>
        </div>
            ...
            <table>
                <tr>
                    <td>
                        <div>
                        <div class="logo"></div>
                        <p class="doctor-sign"><b>Dr (a): </b><span>____Medico _______</span></p>
                        <p><b>N°: </b><span>____Medico _______</span></p>
                    </div>
                    </td>
                    <td >
