...
module.exports = {
        ...
        <style>
            ...
            *,
            ...
            .logo {
                width: 200px;
                height: 100px;
                background-image: url("./caduceus-30591-640_sm.png");
    ...
    <body>
        <header class="header">
            ...
            <div class="logo"></div>
            <div class="content info-factura">
                <p><b>Fecha: </b> ___________</p>
            </div>
        </header>
        <main class="main">
            <hr>
            ...
            <div class="info-patient">
                <p><b>Nombre: </b><span>Juan Carlos Lopez sanchez</span></p>
                <p><b>Documento: </b> ___________</p>
                <p><b>Genero: </b> ___________</p>
                <p><b>Edad: </b> ___________</p>
                <p><b>Estado Civil: </b> ___________</p>
                <p><b>Telefono 1: </b> ___________</p>
                <p><b>Telefono 2: </b> ___________</p>
                <p><b>Dirección: </b> ___________</p>
                <p><b>Tipo Afiliación: </b> ___________</p>
                <p><b>Pagador: </b> ___________</p>
            </div>
            <hr>
            <h3>______ tipo de factura _______</h3>
            <div>
                <ol>
                    <li>
